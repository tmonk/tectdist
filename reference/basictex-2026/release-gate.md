...
| stage | status | detail |
|---|---|---|
| workspace-tests | pass | returncode=0, 89 tests passed |
...
| x10-e-edit | fail | body-edit 1.961x, unchanged 12.583x — below 10x; requires engine-side page checkpoints (documented) |
